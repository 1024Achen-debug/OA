    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="${pageContext.request.contextPath}/wei_bao/update"
                           modelAttribute="info">
                    <form:hidden path="weiBao.id"/>
                    <div class="panel-body bg-light">
                        <div class="section-divider mt20 mb40">
                            <span> 基本信息 </span>
                        </div>
                        <div class="section">
                            <label for="weiBao.cause" class="field prepend-icon">
                                <form:input path="weiBao.cause" cssClass="gui-input" placeholder="事由..."/>
                                <label for="weiBao.cause" class="field-icon">
                        ...
                        <div class="section row">
                            <div class="col-md-3">
                                <label for="totalMoney" class="field prepend-icon">
                                    <form:input id="totalMoney" path="weiBao.totalAmount" cssClass="gui-input"
